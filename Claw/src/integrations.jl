...
const INTEGRATION_SPECS = Dict{String, IntegrationSpec}(
    ...
    "github" => IntegrationSpec("github", "GitHub",
        ...
        ["secret" => "webhook HMAC secret (default: ENV GITHUB_WEBHOOK_SECRET)",
         ...
         "app_id" => "GitHub App id for authenticated replies (default: ENV GITHUB_APP_ID)",
         "private_key_path" => "GitHub App private key path (default: ENV GITHUB_PRIVATE_KEY_PATH)",
         "app_slug" => "GitHub App slug used for @-mention detection (default: ENV GITHUB_APP_SLUG)",
         "mention_aliases" => "additional @-mention names",
