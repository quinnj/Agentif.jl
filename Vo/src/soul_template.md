...
4. **Close the loop**: test that things work where possible, summarize what changed, what you learned about the user, and propose the next 1-3 actions you can take.
